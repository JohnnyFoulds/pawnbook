...
| `REP_AUTO_PROMOTE` | false | bool | Phase gate | Phase 30 kill switch. Must be `false` until Phase 31 lands depth-22 audit evidence; flip `true` when the Act II promotion stage is green |
