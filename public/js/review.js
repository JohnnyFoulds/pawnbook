...
function renderMistakeList(review) {
  ...
  const renderMistake = (m) => {
    ...
    const chip = glyph
      ...
      : '';
    const MOTIF_LABEL = { hanging_piece: 'hanging piece', fork: 'fork', back_rank: 'back rank', missed_capture: 'missed capture', overloaded_defender: 'overloaded defender', pinned_piece: 'pin' };
